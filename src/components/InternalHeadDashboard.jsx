// src/components/InternalHeadDashboard.jsx
  ...
  useEffect(() => {
    const fetchProjects = async () => {
      ...
      if (user) {
        ...
        const q = query(collection(firestore, 'projects'), where('assignedUsers', 'array-contains', { email: userEmail, role: 'internalHead' }));
...
export default InternalHeadDashboard;
